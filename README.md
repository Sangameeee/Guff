# Guff
Guff is a s a real-time communication platform designed to facilitate seamless interaction and messaging among users.It provides a platform for the messaging and interacting with different people. Users can add, block, remove and message friends along with accepting the request of users. Along with that the users can also upload stories and view the ones uploaded by their friends.
...
Guff is a comprehensive communication platform featuring user management, real-time chat, friend management, and story sharing functionalities. It uses **FastAPI** and **MySQL** for the backend, and **ReactJs** for the frontend. WebSockets are used for real-time communication.
